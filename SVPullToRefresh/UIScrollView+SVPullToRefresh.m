...
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler
    ...
    if(!self.pullToRefreshView) {
        ...
        view.doInitialScroll = doScroll;
    }
    
}
- (void)addPullToRefreshWithActionHandler:(void (^)(void))actionHandler position:(SVPullToRefreshPosition)position {
    
    [self addPullToRefreshWithActionHandler:actionHandler position:position doInitialScroll:YES];
...
// public properties
@synthesize pullToRefreshActionHandler, arrowColor, textColor, activityIndicatorViewColor, activityIndicatorViewStyle, lastUpdatedDate, dateFormatter, doInitialScroll;
